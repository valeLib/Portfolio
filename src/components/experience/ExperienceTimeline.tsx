      ...
      <div ref={containerRef}>
        ...
        <div className="mb-16">
          ...
          <p style={{ color: 'var(--muted)' }} className="max-w-2xl">
            Full professional journey across frontend, full-stack, XR development, and research
          </p>
        </div>
        ...
        <div ref={timelineRef} className="relative">
          ...
          {/* Timeline items - All experiences */}
      ...
      >
        ...
        {isMobile && (
          <button
            ...
            className="mt-3 w-full flex items-center justify-center gap-2 py-2 rounded-lg transition-all duration-200 active:scale-95 hover:bg-[rgba(252,119,153,0.1)]"
            style={{
