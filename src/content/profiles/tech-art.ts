// Tech Artist profile content

export const techArtProfile = {
  name: 'Valentina Liberona',
  title: 'Tech Artist',
  tagline: 'Magic VFX, Shaders, Real-time Systems',

  heroHeadline: 'Tech Artist',
  heroSubheadline: 'Creating immersive magic VFX, shaders, and real-time systems for games',
...
export type TechArtProfile = typeof techArtProfile;
